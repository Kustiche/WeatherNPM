...
var _addFavoriteArrayJs = require("./addFavoriteArray.js");
var _deleteFavoriteJs = require("./deleteFavorite.js");
var _cityForecastJs = require("./cityForecast.js");
...
if (isEmptyOutput) {
    (0, _viewJs.cityOutput).textContent = JSON.parse(localStorage.getItem("cityName"));
    (0, _localCityForecastJs.localCityForecast)((0, _viewJs.cityOutput).textContent);
}
(0, _renderJs.render)();
(0, _viewJs.form).addEventListener("submit", (e)=>{
    e.preventDefault();
    cityName = (0, _viewJs.search).value;
    localStorage.setItem("cityName", JSON.stringify(cityName));
    (0, _viewJs.cityOutput).textContent = (0, _viewJs.search).value;
    (0, _weatherAPIJs.weatherAPI)(cityName);
    (0, _weatherAPIJs.forecastAPI)(cityName);
});
(0, _viewJs.favoriteBtn).addEventListener("click", ()=>{
    (0, _addFavoriteArrayJs.addFavoriteArray)();
});
(0, _viewJs.favorites).addEventListener("click", (e)=>{
...
parcelHelpers.export(exports, "cityOutput", ()=>cityOutput);
parcelHelpers.export(exports, "forecast", ()=>forecast);
parcelHelpers.export(exports, "degreeNow", ()=>degreeNow);
parcelHelpers.export(exports, "degreeFelt", ()=>degreeFelt);
parcelHelpers.export(exports, "detailWind", ()=>detailWind);
parcelHelpers.export(exports, "detailHumidity", ()=>detailHumidity);
parcelHelpers.export(exports, "detailSunset", ()=>detailSunset);
parcelHelpers.export(exports, "detailSunrise", ()=>detailSunrise);
parcelHelpers.export(exports, "favoriteBtn", ()=>favoriteBtn);
parcelHelpers.export(exports, "favorites", ()=>favorites);
parcelHelpers.export(exports, "forecasts", ()=>forecasts);
parcelHelpers.export(exports, "search", ()=>search);
parcelHelpers.export(exports, "img", ()=>img);
parcelHelpers.export(exports, "favoriteTemplate", ()=>favoriteTemplate);
parcelHelpers.export(exports, "forecastTemplate", ()=>forecastTemplate);
const form = document.querySelector(".form");
const cityOutput = document.querySelector(".weather__city-output");
const forecast = document.querySelector(".forecast");
const degreeNow = document.querySelector(".weather__degree-excerpt--now");
const degreeFelt = document.querySelector(".weather__degree-excerpt--felt");
const detailWind = document.querySelector(".weather__detail-descr--wind");
const detailHumidity = document.querySelector(".weather__detail-descr--humidity");
const detailSunset = document.querySelector(".weather__detail-descr--sunset");
const detailSunrise = document.querySelector(".weather__detail-descr--sunrise");
const favoriteBtn = document.querySelector(".weather__city-btn");
const favorites = document.querySelector(".weather__favorites");
const forecasts = document.querySelector(".weather__forecasts");
const search = document.querySelector(".form__search");
const img = document.querySelector(".weather__forecast-img");
...
},{}],"spApL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "weatherAPI", ()=>weatherAPI);
parcelHelpers.export(exports, "forecastAPI", ()=>forecastAPI);
var _viewJs = require("./view.js");
var _forecastArrayJs = require("./forecastArray.js");
var _createForecastElementsJs = require("./createForecastElements.js");
...
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "forecastArray", ()=>forecastArray);
parcelHelpers.export(exports, "cleaningForecastArray", ()=>cleaningForecastArray);
let forecastArray = [];
function cleaningForecastArray() {
    forecastArray = [];
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aA6W0":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "createForecastElements", ()=>createForecastElements);
var _viewJs = require("./view.js");
var _forecastArrayJs = require("./forecastArray.js");
var _moment = require("moment");
var _momentDefault = parcelHelpers.interopDefault(_moment);
function createForecastElements(cityName) {
    if (cityName === "") return;
    else {
...
},{}],"jAA3O":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addFavoriteArray", ()=>addFavoriteArray);
var _favoriteArrayJs = require("./favoriteArray.js");
var _renderJs = require("./render.js");
var _viewJs = require("./view.js");
...
},{"./favoriteArray.js":"aAUW5","./render.js":"9k0mC","./view.js":"2GA9o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aAUW5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _addFavoriteDomJs = require("./addFavoriteDom.js");
var _favoriteArrayJs = require("./favoriteArray.js");
var _viewJs = require("./view.js");
function render() {
...
},{"./addFavoriteDom.js":"59ePI","./favoriteArray.js":"aAUW5","./view.js":"2GA9o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"59ePI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "addFavoriteDom", ()=>addFavoriteDom);
var _viewJs = require("./view.js");
function addFavoriteDom(cityName) {
    const item = (0, _viewJs.favoriteTemplate).content.cloneNode(true);
    if (cityName === "") return;
    else {
        item.querySelector(".weather__favorite-excerpt").textContent = cityName;
        (0, _viewJs.favorites).append(item);
    }
}

},{"./view.js":"2GA9o","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2xOfI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./favoriteArray.js":"aAUW5","./render.js":"9k0mC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"6G3iY":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./view.js":"2GA9o","./favoriteArray.js":"aAUW5","./weatherAPI.js":"spApL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["lWQBG","bDbGG"], "bDbGG", "parcelRequire8fb7")
